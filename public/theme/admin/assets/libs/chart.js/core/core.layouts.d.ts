declare namespace _default {
    ...
    /**
       ...
       * @param {LayoutItem} layoutItem - the item to remove from the layouts
       */
...
export type LayoutItem = {
    /**
     * - The position of the item in the chart layouts. Possible values are
    ...
    fullSize: boolean;
    /**
     * - returns true if the layouts item is horizontal (ie. top or bottom)
     */
    ...
    height: number;
    /**
     * - Left edge of the item. Set by layouts system and cannot be used in update
     */
    left: number;
    /**
     * - Top edge of the item. Set by layouts system and cannot be used in update
     */
    top: number;
    /**
     * - Right edge of the item. Set by layouts system and cannot be used in update
     */
    right: number;
    /**
     * - Bottom edge of the item. Set by layouts system and cannot be used in update
     */
    bottom: number;
};
