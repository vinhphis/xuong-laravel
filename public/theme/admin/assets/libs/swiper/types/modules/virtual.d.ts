...
export interface VirtualOptions {
  ...
  /**
   * When enabled (by default) it will update Swiper layouts right after renderExternal called. Useful to disable and update swiper manually when used with render libraries that renders asynchronously
   *
   * @default true
   */
