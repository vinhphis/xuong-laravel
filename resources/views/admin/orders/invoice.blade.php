                        ...
                        <div class="card-body p-4">
                            <div class="row g-3">
                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <h5 class="fs-14 mb-0"><span id="invoice-date">{{$detailOrderUser->created_at->toDateString()}}</span>
                                        <small class="text-muted" id="invoice-time">{{$detailOrderUser->created_at->toTimeString()}}</small></h5>
                                </div>
                                <!--end col-->
                                <div class="col-lg-3 col-6">
                        ...
                        <div class="card-body p-4 border-top border-top-dashed">
                            <div class="row g-3">
                                <div class="col-6">
                                    ...
                                    <p class="text-muted mb-1"><span>Phone: +</span><span id="billing-phone-no">098 108 5402</span>
                                    </p>
