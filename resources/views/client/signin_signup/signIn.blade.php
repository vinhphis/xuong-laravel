                                        ...
                                        <div class="position-relative h-100 d-flex flex-column">
                                            <div class="mb-4">
                                                <a href="index.html" class="d-block">
                                                    <img src="{{asset('theme/admin/assets/images/logo-light.png')}}"
                                                         alt="" height="18">
                                                </a>
                                            </div>
                                            <div class="mt-auto">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted">Chúc bạn có 1 trải nghiệm tuyệt với cùng với chúng
                                                tôi</p>
                                        </div>
                                            ...
                                            <form action="{{ route('client.signIn') }}" method="post">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           id="email" value="{{ old('email') }}" autofocus name="email"
